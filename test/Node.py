...
API1 = "http://192.168.25.109:3050"
API2 = "http://192.168.25.109:3051"
API3 = "http://192.168.25.109:3052"
...
async def main():
    urls = [
        ...
        f"{API2}/proposer/" + {"mgs_teste: ": "sam"}.__str__(),
        f"{API3}/proposer/" + {"mgs_teste: ": "tchau"}.__str__(),
        f"{API1}/proposer/" + {"mgs_teste: ": "Bem-vindo"}.__str__(),f"{API1}/proposer/" + {"mgs_teste: ": "oi"}.__str__(),
        f"{API2}/proposer/" + {"mgs_teste: ": "sam"}.__str__(),
        f"{API3}/proposer/" + {"mgs_teste: ": "tchau"}.__str__(),
        f"{API1}/proposer/" + {"mgs_teste: ": "Bem-vindo"}.__str__(),
        f"{API1}/proposer/" + {"mgs_teste: ": "oi"}.__str__(),
